...
import AntDesign from 'react-native-vector-icons/AntDesign'       //you can write AntDesign instead of AntDesign
import colors from '@utils/colors';

interface PropsType{
    color?:string
};
const Loader: FC<PropsType> = ({color=colors.CONTRAST}) => {     //setting up default color
